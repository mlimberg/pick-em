...
const Text = styled('p')`
  ...
  padding-left: ${props =>
    props.p || props.pl || props.paddingLeft || props.px};
  padding-top: ${props =>
    props.p || props.pt || props.paddingTop || props.py};
  padding-right: ${props =>
    props.p || props.pr || props.paddingRight || props.px};
  padding-bottom: ${props =>
    props.p || props.pb || props.paddingBottom || props.py};
